...
var createChat = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, firstId, secondId, chat, newChat, response, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.body, firstId = _a.firstId, secondId = _a.secondId;
                _b.label = 1;
            case 1:
                _b.trys.push([1, 4, , 5]);
            ...
            case 2:
                chat = _b.sent();
                if (chat)
                    return [2 /*return*/, res.status(200).json(chat)];
                newChat = new chatModel_1.default({
...
var findUserChats = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
...
var findChat = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, firstId, secondId, chat, error_3;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = req.params, firstId = _a.firstId, secondId = _a.secondId;
                _b.label = 1;
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, chatModel_1.default.findOne({
